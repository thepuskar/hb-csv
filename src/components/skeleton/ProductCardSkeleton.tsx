  ...
  return (
    <>
      {generateRandNumArray(count)?.map((count) => (
        <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4" key={count}>
          <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="leading-relaxed my-3 w-1/2 h-3 animate-pulse bg-gray-400"></p>
              <p className="leading-relaxed mt-3 w-full h-3 animate-pulse bg-gray-400"></p>
            </div>
          </div>
        </div>
      ))}
